...
from .utils import combine_tokens, recover_tokens, token2feature
from .vit import VisionTransformer
from ..layers.attn_blocks import CEBlock
from ..layers.domain import ModalityClassifier
...
class VisionTransformerCE(VisionTransformer):
    ...
    def forward_features(self, z, x, mask_z=None, mask_x=None,
                         ...
                         template_label=None, search_label=None, infer=True
                         ):
    ...
    def forward(self, z, x, ce_template_mask=None, ce_keep_rate=None,
        ...
        x, aux_dict = self.forward_features(z, x, ce_template_mask=ce_template_mask, ce_keep_rate=ce_keep_rate,
                                            template_label=template_label, search_label=search_label, infer=infer)
